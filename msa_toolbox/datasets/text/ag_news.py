...
class agNewsDataset(CustomDataset):
    ...
    def __init__(self, dataset_name, data_directory, num_labels=4, num_attributes=0, label_probs=False, data_import_method='HuggingFace',  config_file=None, tokenizer=None , seed = None):
