...
class wikitextDataset(CustomDataset):
    ...
    def __init__(self, dataset_name = "wikitext", data_directory = None, num_labels=2, num_attributes=0, label_probs=False, data_import_method='HuggingFace',  config_file=None, tokenizer=None , seed = None):
